...
async function run() {
    ...
    result.value = null;
    try {
        const { ok, data } = await postJson<{ result?: AiResult; message?: string }>('/cases/ai/analyze', {
            ...props.fields,
            ...
            <template v-else-if="result">
                ...
                <section v-if="result.summary">
                    <div class="mb-1.5 flex items-center justify-between">
                        ...
                        <button v-if="showApply" type="button" class="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 hover:underline" @click="useSummary">
                ...
                <section v-if="result.suggested_priority" class="flex items-center gap-2">
                    ...
                    <button v-if="showApply" type="button" class="text-xs font-medium text-indigo-600 hover:underline" @click="emit('apply-priority', result.suggested_priority)">
                        Apply
                    </button>
                </section>
