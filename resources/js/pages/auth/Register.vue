    ...
    <AuthBase title="Create an account" description="Enter your details below to create your account">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <Label for="firm_name">Firm / Practice name</Label>
                    <Input id="firm_name" type="text" required tabindex="2" autocomplete="organization" v-model="form.firm_name" placeholder="e.g. Sterling & Associates" />
                    <InputError :message="form.errors.firm_name" />
                </div>
